"""Структурированное (JSON) логирование сервиса gamification.

Идентична одноимённому модулю сервиса users: формат логов — общий
контракт со сборщиком логов, а не деталь одного сервиса.
"""
